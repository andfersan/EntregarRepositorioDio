...
namespace Api.Integration.Test
{
    public abstract class BaseIntegration : IDisposable
    {
        ...
        public async Task AdicionarToken()
        {
            ...
            var resultLogin = await PostJsonAsyn(loginDto, $"{hostApi}login", client);
        ...
        // Usado para facilitar, passando somente os objetos, objeto, url, http.
        public static async Task<HttpResponseMessage>PostJsonAsyn(object dataclass, string url, HttpClient client)
        {
